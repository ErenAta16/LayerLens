...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "hyperlora/profiling/_aggregators.pyx"
        ]
    },
    "module_name": "hyperlora.profiling._aggregators"
}
END: Cython Metadata */
...
#define __PYX_HAVE__hyperlora__profiling___aggregators
#define __PYX_HAVE_API__hyperlora__profiling___aggregators
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from "hyperlora.profiling._aggregators" */
...
#define __Pyx_MODULE_NAME "hyperlora.profiling._aggregators"
extern int __pyx_module_is_main_hyperlora__profiling___aggregators;
int __pyx_module_is_main_hyperlora__profiling___aggregators = 0;

/* Implementation of "hyperlora.profiling._aggregators" */
...
#define __pyx_n_u_memview __pyx_string_tab[73]
...
#define __pyx_n_u_pyx_unpickle_Enum __pyx_string_tab[87]
...
#define __pyx_n_u_register __pyx_string_tab[93]
...
#define __pyx_n_u_stop __pyx_string_tab[102]
#define __pyx_n_u_struct __pyx_string_tab[103]
#define __pyx_n_u_test __pyx_string_tab[104]
#define __pyx_n_u_unpack __pyx_string_tab[105]
...
#define __pyx_kp_b_double___Pyx_memviewslice___Pyx __pyx_string_tab[109]
...
*/
  __pyx_t_1 = __pyx_memoryview_copy_new_contig((&__pyx_v_mslice), ((char const *)"c"), __pyx_v_self->view.ndim, __pyx_v_self->view.itemsize, (__pyx_v_flags | PyBUF_C_CONTIGUOUS), __pyx_v_self->dtype_is_object); if (unlikely(PyErr_Occurred())) __PYX_ERR(1, 642, __pyx_L1_error)
  __pyx_v_mslice = __pyx_t_1;
...
*/
  __pyx_t_1 = __pyx_memoryview_copy_new_contig((&__pyx_v_src), ((char const *)"fortran"), __pyx_v_self->view.ndim, __pyx_v_self->view.itemsize, (__pyx_v_flags | PyBUF_F_CONTIGUOUS), __pyx_v_self->dtype_is_object); if (unlikely(PyErr_Occurred())) __PYX_ERR(1, 654, __pyx_L1_error)
...
*/
  __pyx_t_1 = __Pyx_CheckUnpickleChecksum(__pyx_v___pyx_checksum, 0x82a3537, 0x6ae9995, 0xb068931, ((char const *)"name")); if (unlikely(__pyx_t_1 == ((int)-1))) __PYX_ERR(1, 6, __pyx_L1_error)
...
/* "hyperlora/profiling/_aggregators.pyx":6
 * """
 * 
...
static double __pyx_f_9hyperlora_9profiling_12_aggregators_aggregate_scores_c(__Pyx_memviewslice __pyx_v_metrics, __Pyx_memviewslice __pyx_v_weights) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_size;
  ...
  /* "hyperlora/profiling/_aggregators.pyx":7
 * 
 * cdef double aggregate_scores_c(double[:] metrics, double[:] weights):
 *     cdef Py_ssize_t i, size = metrics.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double total_weight = 0.0
...
*/
  __pyx_v_size = (__pyx_v_metrics.shape[0]);

  /* "hyperlora/profiling/_aggregators.pyx":8
 * cdef double aggregate_scores_c(double[:] metrics, double[:] weights):
 *     cdef Py_ssize_t i, size = metrics.shape[0]
 *     cdef double total_weight = 0.0             # <<<<<<<<<<<<<<
 *     cdef double weighted_sum = 0.0
...
*/
  ...
  /* "hyperlora/profiling/_aggregators.pyx":9
 *     cdef Py_ssize_t i, size = metrics.shape[0]
 *     cdef double total_weight = 0.0
 *     cdef double weighted_sum = 0.0             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "hyperlora/profiling/_aggregators.pyx":11
 *     cdef double weighted_sum = 0.0
 * 
 *     for i in range(size):             # <<<<<<<<<<<<<<
...
*/
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "hyperlora/profiling/_aggregators.pyx":12
 * 
 *     for i in range(size):
 *         total_weight += weights[i]             # <<<<<<<<<<<<<<
 *         weighted_sum += metrics[i] * weights[i]
...
*/
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_total_weight = (__pyx_v_total_weight + (*((double *) ( /* dim=0 */ (__pyx_v_weights.data + __pyx_t_4 * __pyx_v_weights.strides[0]) ))));

    /* "hyperlora/profiling/_aggregators.pyx":13
 *     for i in range(size):
 *         total_weight += weights[i]
 *         weighted_sum += metrics[i] * weights[i]             # <<<<<<<<<<<<<<
 * 
...
*/
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = __pyx_v_i;
    __pyx_v_weighted_sum = (__pyx_v_weighted_sum + ((*((double *) ( /* dim=0 */ (__pyx_v_metrics.data + __pyx_t_4 * __pyx_v_metrics.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_weights.data + __pyx_t_5 * __pyx_v_weights.strides[0]) )))));
  }

  /* "hyperlora/profiling/_aggregators.pyx":15
 *         weighted_sum += metrics[i] * weights[i]
 * 
 *     if total_weight == 0:             # <<<<<<<<<<<<<<
 *         return 0.0
 * 
*/
  __pyx_t_6 = (__pyx_v_total_weight == 0.0);
  if (__pyx_t_6) {

    /* "hyperlora/profiling/_aggregators.pyx":16
 * 
 *     if total_weight == 0:
 *         return 0.0             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "hyperlora/profiling/_aggregators.pyx":18
 *         return 0.0
 * 
 *     return weighted_sum / total_weight             # <<<<<<<<<<<<<<
 * 
*/
  ...
  __pyx_r = (__pyx_v_weighted_sum / __pyx_v_total_weight);
  goto __pyx_L0;
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("hyperlora.profiling._aggregators.aggregate_scores_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyType_Spec __pyx_type___pyx_array_spec = {
  "hyperlora.profiling._aggregators.array",
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "hyperlora.profiling._aggregators.""array", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_MemviewEnum_spec = {
  "hyperlora.profiling._aggregators.Enum",
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "hyperlora.profiling._aggregators.""Enum", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_memoryview_spec = {
  "hyperlora.profiling._aggregators.memoryview",
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "hyperlora.profiling._aggregators.""memoryview", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_memoryviewslice_spec = {
  "hyperlora.profiling._aggregators._memoryviewslice",
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "hyperlora.profiling._aggregators.""_memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_9hyperlora_9profiling_12_aggregators_aggregate_scores_c, (void (*)(void)) NULL};
...
static int __pyx_pymod_exec__aggregators(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__aggregators},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "_aggregators",
      __pyx_k_Cython_implementation_takes_sco, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit__aggregators(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__aggregators(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__aggregators(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_aggregators' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "_aggregators" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit__aggregators", 0);
  ...
  if (__pyx_module_is_main_hyperlora__profiling___aggregators) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "hyperlora.profiling._aggregators")) {
      if (unlikely((PyDict_SetItemString(modules, "hyperlora.profiling._aggregators", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  /* "hyperlora/profiling/_aggregators.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init hyperlora.profiling._aggregators", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init hyperlora.profiling._aggregators");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{2},{68},{35},{54},{37},{60},{24},{52},{26},{34},{29},{33},{45},{22},{15},{179},{37},{30},{32},{1},{1},{1},{1},{1},{8},{5},{6},{15},{23},{25},{7},{6},{2},{6},{35},{9},{30},{50},{8},{21},{20},{32},{22},{30},{37},{5},{8},{20},{8},{15},{3},{15},{4},{1},{9},{17},{18},{5},{8},{15},{6},{9},{5},{5},{6},{7},{12},{2},{10},{5},{5},{8},{8},{7},{4},{10},{4},{8},{4},{7},{3},{4},{3},{12},{14},{11},{10},{19},{14},{12},{10},{17},{13},{8},{12},{10},{12},{19},{5},{4},{5},{4},{4},{6},{8},{6},{6},{6},{1},{66},{1}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 